...
class RoomController:
    ...
    def initialize_routes(self):
        ...
        def create_room(room: schemas.RoomCreate, request: Request):
            ...
            return self.service.create_room(room.room_name, room.room_password, jwt_user["id"])
        ...
        @self.router.post("/upload-receipt", response_model=schemas.ReceiptUpload)
        ...
        @self.router.get("/download-receipts/{room_code}", response_model=List[str])
        def download_receipts_from_room(room_code: str):
            return self.service.download_receipts_from_s3_room(room_code)
